...
Usage: python3 Library/preview_generator.py [--icons-dir DIR] [--dry-run] [--force]
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 Library/preview_generator.py                    # Generate all preview images
  python3 Library/preview_generator.py --dry-run          # Preview what would be done
  python3 Library/preview_generator.py --force            # Force regenerate all files
  python3 Library/preview_generator.py --icons-dir custom # Use custom directory
