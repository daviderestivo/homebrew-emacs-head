...
| ~--with-pdumper~          | Enable pdumper support  (only on emacs-head and emacs-head@28)                |
| ~--with-xwidgets~         | Enable xwidgets support (only on emacs-head and emacs-head@28)                |
| ~--with-native-comp~      | Enable Elisp native compilation support (only on emacs-head@28)               |
| ~--with-native-full-aot~  | Enable Elisp Ahead-of-Time native compilation support (only on emacs-head@28) |
...
** Pdumper support
Portable dumper is supported by emacs-head and emacs-head@28. To
enable this feature please use ~--with-pdumper~.
...
~--with-xwidgets~ (only on emacs-head and emacs-head@28).
