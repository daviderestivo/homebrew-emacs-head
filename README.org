...
Bottles for GNU Emacs 26.3 are available for the following macOS versions:
- Catalina
- Mojave
- High Sierra
...
| ~--with-jansson~          | Enable jansson support (only for emacs-head@27 and emaces-head@28)           |
...
| ~--with-pdumper~          | Enable pdumper support  (only for emacs-head@27 and emaces-head@28)          |
| ~--with-xwidgets~         | Enable xwidgets support (only for emacs-head@27 and emaces-head@28)          |
