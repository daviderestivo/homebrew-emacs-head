...
| ~--with-native-comp~      | Enable Elisp native compilation support (only on emacs-head@28 and emacs-head@29)               |
| ~--with-native-full-aot~  | Enable Elisp Ahead-of-Time native compilation support (only on emacs-head@28 and emacs-head@29) |
...
| ~--with-modern-icon-dragon~                          | Use a modern style icon by [[https://emacs-china.org][Emacs-China]]              | [[/icons/modern-icon-dragon.png]]                          | [[https://github.com/willbchang/emacs-dragon-icon][Link]] |
