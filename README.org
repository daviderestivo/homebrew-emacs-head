...
| ~--with-modern-icon-vscode-emacs~                    | Use a modern style icon by [[https://github.com/vdegenne][Valentin Degenne]]         | [[/icons/modern-icon-vscode-emacs.png]]                    | [[https://github.com/VSCodeEmacs/Emacs][Link]] |
...
| ~--with-modern-icon-purple-flat~                     | Use a modern style icon by [[https://jeremiahfoster.com][Jeremiah Foster]]          | [[/icons/modern-icon-black-variant.png]]                   | [[https://icon-icons.com/icon/emacs/103962][Link]] |
