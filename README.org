...
- GNU Emacs 26.3
- GNU Emacs 27.1-rc1 (or HEAD)
- GNU Emacs HEAD (currently 28.0.50)

Bottles for GNU Emacs 26.3 and 27.1-rc1 are available for the following
macOS versions:
- Catalina
- Mojave
- High Sierra
...
GNU Emacs 27.1-rc1 bottles have been built with the following options:
